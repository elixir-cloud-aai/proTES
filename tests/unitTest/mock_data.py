...
LIST_TASK_CONFIG = {"default_page_size": 5}
...
MOCK_TASK_MINIMAL1 = {"task_log": {"id": "task-53ef00fd", "state": "COMPLETE"}}

MOCK_TASK_MINIMAL2 = {"task_log": {"id": "task-27e61564", "state": "COMPLETE"}}

MOCK_TASK_MINIMAL3 = {"task_log": {"id": "task-c2cfdc1b", "state": "CANCELED"}}
        ...
        "logs": [
            {
                ...
                "metadata": {"USER_ID": "anonymousUser"},
...
MOCK_TASKS_BASIC_LIST = [MOCK_TASK_BASIC1, MOCK_TASK_BASIC2]
